                ...
                <div class="sl-card-item file-card is-starred">
                    ...
                    <div class="sl-card-actions">
                        ...
                        <button type="button" 
                                ...
                                title="Unfavorite">
                            <svg viewBox="0 0 24 24" fill="#fbbf24" stroke="#f59e0b" stroke-width="1.5" style="width: 14px; height: 14px; margin-right: 4px; display: inline-block; vertical-align: middle;"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg> Unstar
                        </button>
                    </div>
                </div>
            <?php endforeach; ?>
